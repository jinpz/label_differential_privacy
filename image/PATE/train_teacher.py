...
from lib.dataset.mnist import get_mnist10
...
if __name__ == "__main__":
    ...
    if not os.path.exists(args.common.model_dir):
        os.makedirs(args.common.model_dir)
    ...
    os.system("touch {0}complete.txt".format(args.common.model_dir))
